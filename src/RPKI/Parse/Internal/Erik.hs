...
parseErikIndex :: Validator es => BS.ByteString -> Eff es ErikIndex
...
parseErikPartition :: Validator es => BS.ByteString -> Eff es ErikPartition
...
parseErikSegmentIndex :: Validator es => BS.ByteString -> Eff es ErikSegmentIndex
