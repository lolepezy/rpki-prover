...
--
-- With 'onlyRestrictWrites' only writing is restricted (to 'readWrite'), reading,
...
sandboxVariables = [rwVariable, roVariable, onlyRestrictWritesVariable]

rwVariable, roVariable, onlyRestrictWritesVariable :: String
rwVariable = "RPKI_PROVER_SANDBOX_RW"
roVariable = "RPKI_PROVER_SANDBOX_RO"
onlyRestrictWritesVariable = "RPKI_PROVER_SANDBOX_ONLY_RESTRICT_WRITES"
...
sandboxEnvironment WorkerSandbox {..} = [
    ...
    ] <> [ (onlyRestrictWritesVariable, "1") | onlyRestrictWrites ]
